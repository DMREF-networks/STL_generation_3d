# This is the file to run to convert the numpy files to STL files
# Authors: Katie Newhall, James [Last Name], Sarayu Kondaveeti
...
# This function converts the CSV file generated by the function above to STL files 
