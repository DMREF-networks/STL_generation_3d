...
def numpy_to_csv(inputPath, outputPath):
    import subprocess 
...
def csv_to_stl(inputPath, outputPath, beamDiameter):
    numpy_to_csv(inputPath, outputPath)
...
csv_to_stl(inputPath, outputPath, 0.04)