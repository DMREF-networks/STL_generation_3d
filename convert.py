...
def main():
    ...
    parser = argparse.ArgumentParser(description="Convert numpy arrays to CSV files.")
    parser.add_argument('src_directory', type=str, help="Source directory containing numpy arrays.")
    parser.add_argument('dst_directory', type=str, help="Destination directory to save CSV files.")
    args = parser.parse_args()

    convert_npy_to_csv(args.src_directory, args.dst_directory)
